# MarketBeat — Client Intelligence (Updated March 2026)

---

## 1. CLIENT OVERVIEW

**Company:** MarketBeat (marketbeat.com / mattpaulson.com)
**Industry:** Financial publishing / Stock market research
**Revenue:** ~$55M/year
...
| **Nathan May** | Agency Principal / Strategic Lead |
...
**Primary KPI:** ROAS on ad spend (Revenue / Ad Spend)
...
5. **NEVER use nuclear/energy B-roll or imagery in ads** — Matt personally killed DCT_149 on Mar 6, 2026: "Please pause the nuclear mess magnet ad" / "That's the ad that got our old account banned." Nuclear imagery triggers Meta's political/social issues policy and risks account ban. (Precedent: Oct 2025 — similar B-roll got original MarketBeat ad account banned.) The nuclear stocks *landing page* may still be usable, but creative assets must not contain nuclear footage/imagery.

### Approved Tone
- Authority-driven, data-backed, actionable
- "Smart money" positioning — readers get an edge
- Two distinct ICPs with different hooks:
...
**Format 1: Text-Over-Video (TFM Strength)**
- Consistent performer across MarketBeat and other TFM accounts
- UGC-style with financial data overlays

**Format 2: Market Timing / Breaking News Hooks**
- January Effect creative: 102% ROAS — best single creative in account history
- Timely hooks tied to market events massively outperform evergreen

**Format 3: Premium Report LP (GrowJoy Playbook — Now Available to TFM)**
- Themed PDF offers: spacestocks, top5, newyear
...
## 7. GROWJOY COMPETITIVE ANALYSIS

*Data sourced from Meta Ads Manager (Pipeboard), Slack ROAS reports, and Day AI.*

### Ad Account Overview (act_1129788478833121 — MarketBeat Media, LLC)

**3 active campaigns as of March 9, 2026:**

| Campaign | Agency | Daily Budget | Bid Strategy | Start Date |
|----------|--------|-------------|--------------|------------|
| Growjoy - Leads Campaign - Special Category | GrowJoy | CBO (no cap) | Lowest Cost | May 30, 2025 |
...
| Metric | TFM | GrowJoy | Gap |
|--------|-----|---------|-----|
| **Spend** | $14,965 | $71,942 | GJ 4.8x |
| **Revenue** | $5,957 | $31,374 | — |
| **ROAS** | 39.8% | 43.6% | **-3.8 pts** |
| **Revenue Leads** | 1,298 | 6,419 | — |
| **Meta Website Leads** | 1,265 | 4,647 | — |
| **CPL (Revenue Leads)** | **$11.53** | **$11.21** | **GJ $0.32 cheaper** |
| **Rev/User** | $4.59 | $4.89 | -$0.30 |
| **Confirmed Sales** | 5 | 32 | — |
| **SMS Opt-ins** | 216 | 1,529 | **GJ 7x more** |

### Pipeboard / Meta Ads Account Data (March 1–9)

| Metric | TFM | GrowJoy (Main) | GrowJoy (CBO) |
|--------|-----|----------------|----------------|
| **Spend** | $16,546 | $79,133 | $406 |
| **Impressions** | 429,209 | 1,431,127 | 6,091 |
| **Pixel Leads** | 1,391 | 5,116 | 31 |
| **CPL (pixel)** | $11.90 | $15.47 | $13.11 |
| **CTR** | 3.76% | 7.90% | 9.23% |
| **CPC** | $1.03 | $0.70 | $0.72 |
| **CPM** | $38.55 | $55.29 | $66.70 |
...
| Ad / DCT | Spend | Leads | CPL | CTR | Status |
|-----------|-------|-------|-----|-----|--------|
| DCT_130_2 Waves | $6,110 | 506 | $12.08 | 2.85% | PAUSED (just paused 3/9) |
| DCT_132_Attention Near Retiree | $3,946 | 343 | **$11.50** | 5.07% | **ACTIVE** — best volume+CPL |
| DCT_131_Sector Rotation Clock | $2,859 | 255 | **$11.21** | 3.71% | PAUSED |
| DCT_140_10 Stocks Checklist | $1,569 | 120 | $13.08 | 3.84% | **ACTIVE** |
...
| Ad Set | Spend | Leads | CPL | CTR |
|--------|-------|-------|-----|-----|
| Feb 7 2.2 (**whale**) | $27,199 | 1,602 | $16.98 | 7.90% |
| Feb 7 2.3 | $16,788 | 1,060 | $15.84 | 9.04% |
| Feb 7 2 | $14,269 | 848 | $16.83 | 9.63% |
| Jan 30 | $8,313 | 630 | $13.20 | 4.75% |
| Feb 3 | $4,185 | 276 | $15.16 | 14.26% |
| Feb 7 | $3,357 | 304 | $11.04 | 6.48% |
| Mar 5 (newest) | $1,679 | 127 | $13.22 | 3.65% |
| Feb 4 | $1,679 | 138 | $12.16 | 8.01% |
...
#### 1. Dynamic Creative vs. Single Creative
- **GrowJoy:** Every ad set uses `is_dynamic_creative: true`. Multiple creative variants stuffed into each ad set — Meta optimizes delivery across them.
- **TFM:** One creative concept per ad set (DCT_130, DCT_131, etc.). Cleaner testing but less automated optimization.

**Implication:** GrowJoy lets Meta's algorithm pick winners from a creative pool. TFM should test dynamic creative bundles.
...
#### 3. Targeting (Nearly Identical)
Both agencies use:
- **Broad targeting:** US only, ages 18-65
- **Same exclusion list:** `most-recent-5m-subs.csv`
- **Optimization:** Offsite conversions (lead pixel)
- **Billing:** Impressions
- **Bid strategy:** Lowest cost without cap

**Key difference:** Some TFM ad sets use interest targeting (Stock exchange, Stock, Stock market) while GrowJoy is **100% broad**. Some TFM ad sets have `advantage_audience: 0` (Advantage+ disabled) while GrowJoy ad sets vary.

#### 4. Budget Concentration
- **GrowJoy whale ad set** (Feb 7 2.2): $4,000/day budget, $27K spend in 9 days
- **GrowJoy secondary** (Feb 7 2.3): $2,700/day
- **TFM entire campaign:** $2,000/day total across all ad sets
